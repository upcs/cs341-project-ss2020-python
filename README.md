...
### Website Design
Began implementing html and css of the home page. In addition to this, the heat map page to display pollution and energy use of cities has also started to be developed.
